    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.staff-transfer-infos.update", [$staffTransferInfo->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="period" id="period" value="{{ old('period', $staffTransferInfo->period) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="from_user" id="from_user" value="{{ old('from_user', $staffTransferInfo->from_user) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="to_user" id="to_user" value="{{ old('to_user', $staffTransferInfo->to_user) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="transfer_date" id="transfer_date" value="{{ old('transfer_date', $staffTransferInfo->transfer_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="approved_by_user" id="approved_by_user" value="{{ old('approved_by_user', $staffTransferInfo->approved_by_user) }}">
