                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.seminars.update", [$seminar->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="topic" id="topic" value="{{ old('topic', $seminar->topic) }}">
                            @if($errors->has('topic'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('topic') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="remark" id="remark" value="{{ old('remark', $seminar->remark) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="seminar_date" id="seminar_date" value="{{ old('seminar_date', $seminar->seminar_date) }}">
