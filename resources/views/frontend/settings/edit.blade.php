                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.settings.update", [$setting->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="no_of_periods" id="no_of_periods" value="{{ old('no_of_periods', $setting->no_of_periods) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="no_of_semester" id="no_of_semester" value="{{ old('no_of_semester', $setting->no_of_semester) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="semester_type" id="semester_type" value="{{ old('semester_type', $setting->semester_type) }}">
