    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.industrial-experiences.update", [$industrialExperience->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="work_experience" id="work_experience" value="{{ old('work_experience', $industrialExperience->work_experience) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="designation" id="designation" value="{{ old('designation', $industrialExperience->designation) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="from" id="from" value="{{ old('from', $industrialExperience->from) }}">
                            @if($errors->has('from'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('from') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="to" id="to" value="{{ old('to', $industrialExperience->to) }}">
                            @if($errors->has('to'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('to') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="work_type" id="work_type" value="{{ old('work_type', $industrialExperience->work_type) }}">
