    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.email-settings.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="smtp_secure" id="smtp_secure" value="{{ old('smtp_secure', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="port_no" id="port_no" value="{{ old('port_no', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cc" id="cc" value="{{ old('cc', '') }}">
                            @if($errors->has('cc'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cc') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="bcc" id="bcc" value="{{ old('bcc', '') }}">
                            @if($errors->has('bcc'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('bcc') }}
                                </div>
