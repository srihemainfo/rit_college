    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.college-calenders.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="academic_year" id="academic_year" value="{{ old('academic_year', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="shift" id="shift" value="{{ old('shift', '') }}">
                            @if($errors->has('shift'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('shift') }}
                                </div>
