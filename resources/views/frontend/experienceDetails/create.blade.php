    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.experience-details.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="years_of_experience" id="years_of_experience" value="{{ old('years_of_experience', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="worked_place" id="worked_place" value="{{ old('worked_place', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="taken_subjects" id="taken_subjects" value="{{ old('taken_subjects', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="from_date" id="from_date" value="{{ old('from_date') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="to_date" id="to_date" value="{{ old('to_date') }}" required>
