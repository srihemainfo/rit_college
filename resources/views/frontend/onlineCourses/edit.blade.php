    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.online-courses.update", [$onlineCourse->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="course_name" id="course_name" value="{{ old('course_name', $onlineCourse->course_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="remark" id="remark" value="{{ old('remark', $onlineCourse->remark) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="from_date" id="from_date" value="{{ old('from_date', $onlineCourse->from_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="to_date" id="to_date" value="{{ old('to_date', $onlineCourse->to_date) }}">
