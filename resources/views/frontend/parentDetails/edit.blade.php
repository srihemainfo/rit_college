    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.parent-details.update", [$parentDetail->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="father_name">{{ trans('cruds.parentDetail.fields.father_name') }}</label>
                            <input class="form-control" type="text" name="father_name" id="father_name" value="{{ old('father_name', $parentDetail->father_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="father_mobile_no" id="father_mobile_no" value="{{ old('father_mobile_no', $parentDetail->father_mobile_no) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="fathers_occupation" id="fathers_occupation" value="{{ old('fathers_occupation', $parentDetail->fathers_occupation) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mother_name" id="mother_name" value="{{ old('mother_name', $parentDetail->mother_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mother_mobile_no" id="mother_mobile_no" value="{{ old('mother_mobile_no', $parentDetail->mother_mobile_no) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mothers_occupation" id="mothers_occupation" value="{{ old('mothers_occupation', $parentDetail->mothers_occupation) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="guardian_name" id="guardian_name" value="{{ old('guardian_name', $parentDetail->guardian_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="guardian_mobile_no" id="guardian_mobile_no" value="{{ old('guardian_mobile_no', $parentDetail->guardian_mobile_no) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="gaurdian_occupation" id="gaurdian_occupation" value="{{ old('gaurdian_occupation', $parentDetail->gaurdian_occupation) }}">
