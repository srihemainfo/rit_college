    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.educational-details.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="institute_name" id="institute_name" value="{{ old('institute_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="institute_location" id="institute_location" value="{{ old('institute_location', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="board_or_university" id="board_or_university" value="{{ old('board_or_university', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="marks" id="marks" value="{{ old('marks', '') }}">
                            @if($errors->has('marks'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('marks') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="marks_in_percentage" id="marks_in_percentage" value="{{ old('marks_in_percentage', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="subject_1" id="subject_1" value="{{ old('subject_1', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mark_1" id="mark_1" value="{{ old('mark_1', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="subject_2" id="subject_2" value="{{ old('subject_2', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mark_2" id="mark_2" value="{{ old('mark_2', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="subject_3" id="subject_3" value="{{ old('subject_3', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mark_3" id="mark_3" value="{{ old('mark_3', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="subject_4" id="subject_4" value="{{ old('subject_4', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mark_4" id="mark_4" value="{{ old('mark_4', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="subject_5" id="subject_5" value="{{ old('subject_5', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mark_5" id="mark_5" value="{{ old('mark_5', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="subject_6" id="subject_6" value="{{ old('subject_6', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mark_6" id="mark_6" value="{{ old('mark_6', '') }}">
