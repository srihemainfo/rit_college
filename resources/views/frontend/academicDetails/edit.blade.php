    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.academic-details.update", [$academicDetail->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="register_number" id="register_number" value="{{ old('register_number', $academicDetail->register_number) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="emis_number" id="emis_number" value="{{ old('emis_number', $academicDetail->emis_number) }}">
