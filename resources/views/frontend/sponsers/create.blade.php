    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.sponsers.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sponser_type" id="sponser_type" value="{{ old('sponser_type', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sponser_name" id="sponser_name" value="{{ old('sponser_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sponsered_items" id="sponsered_items" value="{{ old('sponsered_items', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sponsered_to" id="sponsered_to" value="{{ old('sponsered_to', '') }}">
