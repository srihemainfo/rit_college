    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.leave-staff-allocations.update", [$leaveStaffAllocation->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="no_of_leave" id="no_of_leave" value="{{ old('no_of_leave', $leaveStaffAllocation->no_of_leave) }}" step="1" required>
