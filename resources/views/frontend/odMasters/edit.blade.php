    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.od-masters.update", [$odMaster->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.odMaster.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $odMaster->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="level_1_role" id="level_1_role" value="{{ old('level_1_role', $odMaster->level_1_role) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="level_2_role" id="level_2_role" value="{{ old('level_2_role', $odMaster->level_2_role) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="level_3_role" id="level_3_role" value="{{ old('level_3_role', $odMaster->level_3_role) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="approved_by" id="approved_by" value="{{ old('approved_by', $odMaster->approved_by) }}" required>
