    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.personal-details.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mobile_number" id="mobile_number" value="{{ old('mobile_number', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="aadhar_number" id="aadhar_number" value="{{ old('aadhar_number', '') }}">
