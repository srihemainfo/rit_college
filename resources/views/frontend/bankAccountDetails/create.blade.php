    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.bank-account-details.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="account_type">{{ trans('cruds.bankAccountDetail.fields.account_type') }}</label>
                            <input class="form-control" type="text" name="account_type" id="account_type" value="{{ old('account_type', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="bank_location" id="bank_location" value="{{ old('bank_location', '') }}">
