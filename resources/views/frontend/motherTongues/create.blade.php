    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.mother-tongues.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="mother_tongue">{{ trans('cruds.motherTongue.fields.mother_tongue') }}</label>
                            <input class="form-control" type="text" name="mother_tongue" id="mother_tongue" value="{{ old('mother_tongue', '') }}">
