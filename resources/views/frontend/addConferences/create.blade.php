    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.add-conferences.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="topic_name" id="topic_name" value="{{ old('topic_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="conference_date" id="conference_date" value="{{ old('conference_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contribution_of_conference" id="contribution_of_conference" value="{{ old('contribution_of_conference', '') }}">
