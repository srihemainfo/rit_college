    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.internship-requests.update", [$internshipRequest->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="user">{{ trans('cruds.internshipRequest.fields.user') }}</label>
                            <input class="form-control" type="text" name="user" id="user" value="{{ old('user', $internshipRequest->user) }}">
                            @if($errors->has('user'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="from_date" id="from_date" value="{{ old('from_date', $internshipRequest->from_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="to_date" id="to_date" value="{{ old('to_date', $internshipRequest->to_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="level_1_userid" id="level_1_userid" value="{{ old('level_1_userid', $internshipRequest->level_1_userid) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="level_2_userid" id="level_2_userid" value="{{ old('level_2_userid', $internshipRequest->level_2_userid) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="level_3_userid" id="level_3_userid" value="{{ old('level_3_userid', $internshipRequest->level_3_userid) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="approved_by" id="approved_by" value="{{ old('approved_by', $internshipRequest->approved_by) }}">
