    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.course-enroll-masters.update", [$courseEnrollMaster->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="enroll_master_number">{{ trans('cruds.courseEnrollMaster.fields.enroll_master_number') }}</label>
                            <input class="form-control" type="text" name="enroll_master_number" id="enroll_master_number" value="{{ old('enroll_master_number', $courseEnrollMaster->enroll_master_number) }}" required>
