    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.entrance-exams.update", [$entranceExam->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="passing_year" id="passing_year" value="{{ old('passing_year', $entranceExam->passing_year) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="scored_mark" id="scored_mark" value="{{ old('scored_mark', $entranceExam->scored_mark) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="total_mark" id="total_mark" value="{{ old('total_mark', $entranceExam->total_mark) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="rank" id="rank" value="{{ old('rank', $entranceExam->rank) }}">
                            @if($errors->has('rank'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('rank') }}
                                </div>
