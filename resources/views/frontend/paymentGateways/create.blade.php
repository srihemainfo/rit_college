    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.payment-gateways.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="gateway_type">{{ trans('cruds.paymentGateway.fields.gateway_type') }}</label>
                            <input class="form-control" type="text" name="gateway_type" id="gateway_type" value="{{ old('gateway_type', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="merchand" id="merchand" value="{{ old('merchand', '') }}">
