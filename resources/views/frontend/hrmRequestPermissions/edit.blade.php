    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.hrm-request-permissions.update", [$hrmRequestPermission->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="no_of_hours" id="no_of_hours" value="{{ old('no_of_hours', $hrmRequestPermission->no_of_hours) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="from_date" id="from_date" value="{{ old('from_date', $hrmRequestPermission->from_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="reason" id="reason" value="{{ old('reason', $hrmRequestPermission->reason) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="approved_by" id="approved_by" value="{{ old('approved_by', $hrmRequestPermission->approved_by) }}">
