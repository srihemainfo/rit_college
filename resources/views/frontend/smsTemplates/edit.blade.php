    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.sms-templates.update", [$smsTemplate->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="name">{{ trans('cruds.smsTemplate.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $smsTemplate->name) }}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sender" id="sender" value="{{ old('sender', $smsTemplate->sender) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="template" id="template" value="{{ old('template', $smsTemplate->template) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="type" id="type" value="{{ old('type', $smsTemplate->type) }}">
                            @if($errors->has('type'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('type') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="content" id="content" value="{{ old('content', $smsTemplate->content) }}">
