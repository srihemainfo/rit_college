                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.addresses.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="room_no_and_street" id="room_no_and_street" value="{{ old('room_no_and_street', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="area_name" id="area_name" value="{{ old('area_name', '') }}">
