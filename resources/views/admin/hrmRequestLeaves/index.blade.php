...
@can('hrm_request_leaf_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.hrm-request-leaves.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-HrmRequestLeaf">
            <thead>
                <tr>
                    <th width="10">
...
@can('hrm_request_leaf_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.hrm-request-leaves.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.hrm-request-leaves.index') }}",
    columns: [
