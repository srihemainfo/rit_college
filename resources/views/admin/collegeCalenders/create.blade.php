...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.collegeCalender.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.college-calenders.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('academic_year') ? 'is-invalid' : '' }}" type="text" name="academic_year" id="academic_year" value="{{ old('academic_year', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shift') ? 'is-invalid' : '' }}" type="text" name="shift" id="shift" value="{{ old('shift', '') }}">
                @if($errors->has('shift'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('semester_type') ? 'is-invalid' : '' }}" type="text" name="semester_type" id="semester_type" value="{{ old('semester_type', '') }}">
