...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.saboticals.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('eligiblity_approve') ? 'is-invalid' : '' }}" type="text" name="eligiblity_approve" id="eligiblity_approve" value="{{ old('eligiblity_approve', '') }}">
