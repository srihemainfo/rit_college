    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sms-templates.update", [$smsTemplate->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $smsTemplate->name) }}">
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sender') ? 'is-invalid' : '' }}" type="text" name="sender" id="sender" value="{{ old('sender', $smsTemplate->sender) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('template') ? 'is-invalid' : '' }}" type="text" name="template" id="template" value="{{ old('template', $smsTemplate->template) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" type="text" name="type" id="type" value="{{ old('type', $smsTemplate->type) }}">
                @if($errors->has('type'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('content') ? 'is-invalid' : '' }}" type="text" name="content" id="content" value="{{ old('content', $smsTemplate->content) }}">
