    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.bank-account-details.update", [$bankAccountDetail->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account_type') ? 'is-invalid' : '' }}" type="text" name="account_type" id="account_type" value="{{ old('account_type', $bankAccountDetail->account_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account_no') ? 'is-invalid' : '' }}" type="text" name="account_no" id="account_no" value="{{ old('account_no', $bankAccountDetail->account_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ifsc_code') ? 'is-invalid' : '' }}" type="text" name="ifsc_code" id="ifsc_code" value="{{ old('ifsc_code', $bankAccountDetail->ifsc_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bank_name') ? 'is-invalid' : '' }}" type="text" name="bank_name" id="bank_name" value="{{ old('bank_name', $bankAccountDetail->bank_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('branch_name') ? 'is-invalid' : '' }}" type="text" name="branch_name" id="branch_name" value="{{ old('branch_name', $bankAccountDetail->branch_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bank_location') ? 'is-invalid' : '' }}" type="text" name="bank_location" id="bank_location" value="{{ old('bank_location', $bankAccountDetail->bank_location) }}">
