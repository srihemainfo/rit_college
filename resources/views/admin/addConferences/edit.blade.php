...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.add-conferences.update", [$addConference->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('topic_name') ? 'is-invalid' : '' }}" type="text" name="topic_name" id="topic_name" value="{{ old('topic_name', $addConference->topic_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('location') ? 'is-invalid' : '' }}" type="text" name="location" id="location" value="{{ old('location', $addConference->location) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('conference_date') ? 'is-invalid' : '' }}" type="text" name="conference_date" id="conference_date" value="{{ old('conference_date', $addConference->conference_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contribution_of_conference') ? 'is-invalid' : '' }}" type="text" name="contribution_of_conference" id="contribution_of_conference" value="{{ old('contribution_of_conference', $addConference->contribution_of_conference) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('project_name') ? 'is-invalid' : '' }}" type="text" name="project_name" id="project_name" value="{{ old('project_name', $addConference->project_name) }}">
