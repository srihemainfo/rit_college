...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.od-masters.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_1_role') ? 'is-invalid' : '' }}" type="text" name="level_1_role" id="level_1_role" value="{{ old('level_1_role', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_2_role') ? 'is-invalid' : '' }}" type="text" name="level_2_role" id="level_2_role" value="{{ old('level_2_role', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_3_role') ? 'is-invalid' : '' }}" type="text" name="level_3_role" id="level_3_role" value="{{ old('level_3_role', '') }}" required>
