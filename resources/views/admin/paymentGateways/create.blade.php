    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.payment-gateways.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gateway_type') ? 'is-invalid' : '' }}" type="text" name="gateway_type" id="gateway_type" value="{{ old('gateway_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('merchand') ? 'is-invalid' : '' }}" type="text" name="merchand" id="merchand" value="{{ old('merchand', '') }}">
