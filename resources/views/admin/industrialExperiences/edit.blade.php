...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.industrialExperience.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.industrial-experiences.update", [$industrialExperience->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('user_name') ? 'is-invalid' : '' }}" name="user_name_id" id="user_name_id">
                    @foreach($user_names as $id => $entry)
                        <option value="{{ $id }}" {{ (old('user_name_id') ? old('user_name_id') : $industrialExperience->user_name->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('work_experience') ? 'is-invalid' : '' }}" type="text" name="work_experience" id="work_experience" value="{{ old('work_experience', $industrialExperience->work_experience) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('designation') ? 'is-invalid' : '' }}" type="text" name="designation" id="designation" value="{{ old('designation', $industrialExperience->designation) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('from') ? 'is-invalid' : '' }}" type="text" name="from" id="from" value="{{ old('from', $industrialExperience->from) }}">
                @if($errors->has('from'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('to') ? 'is-invalid' : '' }}" type="text" name="to" id="to" value="{{ old('to', $industrialExperience->to) }}">
                @if($errors->has('to'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('work_type') ? 'is-invalid' : '' }}" type="text" name="work_type" id="work_type" value="{{ old('work_type', $industrialExperience->work_type) }}">
