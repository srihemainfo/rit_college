...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.parent-details.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('father_mobile_no') ? 'is-invalid' : '' }}" type="text" name="father_mobile_no" id="father_mobile_no" value="{{ old('father_mobile_no', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mother_mobile_no') ? 'is-invalid' : '' }}" type="text" name="mother_mobile_no" id="mother_mobile_no" value="{{ old('mother_mobile_no', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('guardian_name') ? 'is-invalid' : '' }}" type="text" name="guardian_name" id="guardian_name" value="{{ old('guardian_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gaurdian_occupation') ? 'is-invalid' : '' }}" type="text" name="gaurdian_occupation" id="gaurdian_occupation" value="{{ old('gaurdian_occupation', '') }}">
