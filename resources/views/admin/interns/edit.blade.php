...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.interns.update", [$intern->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('topic') ? 'is-invalid' : '' }}" type="text" name="topic" id="topic" value="{{ old('topic', $intern->topic) }}">
                @if($errors->has('topic'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('from_date') ? 'is-invalid' : '' }}" type="text" name="from_date" id="from_date" value="{{ old('from_date', $intern->from_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('to_date') ? 'is-invalid' : '' }}" type="text" name="to_date" id="to_date" value="{{ old('to_date', $intern->to_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('progress_report') ? 'is-invalid' : '' }}" type="text" name="progress_report" id="progress_report" value="{{ old('progress_report', $intern->progress_report) }}">
