...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.staffTransferInfo.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.staff-transfer-infos.update", [$staffTransferInfo->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('enroll_master') ? 'is-invalid' : '' }}" name="enroll_master_id" id="enroll_master_id" required>
                    @foreach($enroll_masters as $id => $entry)
                        <option value="{{ $id }}" {{ (old('enroll_master_id') ? old('enroll_master_id') : $staffTransferInfo->enroll_master->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period') ? 'is-invalid' : '' }}" type="text" name="period" id="period" value="{{ old('period', $staffTransferInfo->period) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('from_user') ? 'is-invalid' : '' }}" type="text" name="from_user" id="from_user" value="{{ old('from_user', $staffTransferInfo->from_user) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('to_user') ? 'is-invalid' : '' }}" type="text" name="to_user" id="to_user" value="{{ old('to_user', $staffTransferInfo->to_user) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transfer_date') ? 'is-invalid' : '' }}" type="text" name="transfer_date" id="transfer_date" value="{{ old('transfer_date', $staffTransferInfo->transfer_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('approved_by_user') ? 'is-invalid' : '' }}" type="text" name="approved_by_user" id="approved_by_user" value="{{ old('approved_by_user', $staffTransferInfo->approved_by_user) }}">
