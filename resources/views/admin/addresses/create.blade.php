    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.addresses.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('room_no_and_street') ? 'is-invalid' : '' }}" type="text" name="room_no_and_street" id="room_no_and_street" value="{{ old('room_no_and_street', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('area_name') ? 'is-invalid' : '' }}" type="text" name="area_name" id="area_name" value="{{ old('area_name', '') }}">
