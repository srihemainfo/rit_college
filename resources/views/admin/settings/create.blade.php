    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_of_periods') ? 'is-invalid' : '' }}" type="text" name="no_of_periods" id="no_of_periods" value="{{ old('no_of_periods', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_of_semester') ? 'is-invalid' : '' }}" type="text" name="no_of_semester" id="no_of_semester" value="{{ old('no_of_semester', '') }}">
