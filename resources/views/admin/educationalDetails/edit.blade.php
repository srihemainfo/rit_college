...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.educational-details.update", [$educationalDetail->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('institute_name') ? 'is-invalid' : '' }}" type="text" name="institute_name" id="institute_name" value="{{ old('institute_name', $educationalDetail->institute_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('institute_location') ? 'is-invalid' : '' }}" type="text" name="institute_location" id="institute_location" value="{{ old('institute_location', $educationalDetail->institute_location) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('board_or_university') ? 'is-invalid' : '' }}" type="text" name="board_or_university" id="board_or_university" value="{{ old('board_or_university', $educationalDetail->board_or_university) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('marks') ? 'is-invalid' : '' }}" type="text" name="marks" id="marks" value="{{ old('marks', $educationalDetail->marks) }}">
                @if($errors->has('marks'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('marks_in_percentage') ? 'is-invalid' : '' }}" type="text" name="marks_in_percentage" id="marks_in_percentage" value="{{ old('marks_in_percentage', $educationalDetail->marks_in_percentage) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subject_1') ? 'is-invalid' : '' }}" type="text" name="subject_1" id="subject_1" value="{{ old('subject_1', $educationalDetail->subject_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mark_1') ? 'is-invalid' : '' }}" type="text" name="mark_1" id="mark_1" value="{{ old('mark_1', $educationalDetail->mark_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subject_2') ? 'is-invalid' : '' }}" type="text" name="subject_2" id="subject_2" value="{{ old('subject_2', $educationalDetail->subject_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mark_2') ? 'is-invalid' : '' }}" type="text" name="mark_2" id="mark_2" value="{{ old('mark_2', $educationalDetail->mark_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subject_3') ? 'is-invalid' : '' }}" type="text" name="subject_3" id="subject_3" value="{{ old('subject_3', $educationalDetail->subject_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mark_3') ? 'is-invalid' : '' }}" type="text" name="mark_3" id="mark_3" value="{{ old('mark_3', $educationalDetail->mark_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subject_4') ? 'is-invalid' : '' }}" type="text" name="subject_4" id="subject_4" value="{{ old('subject_4', $educationalDetail->subject_4) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mark_4') ? 'is-invalid' : '' }}" type="text" name="mark_4" id="mark_4" value="{{ old('mark_4', $educationalDetail->mark_4) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subject_5') ? 'is-invalid' : '' }}" type="text" name="subject_5" id="subject_5" value="{{ old('subject_5', $educationalDetail->subject_5) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mark_5') ? 'is-invalid' : '' }}" type="text" name="mark_5" id="mark_5" value="{{ old('mark_5', $educationalDetail->mark_5) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subject_6') ? 'is-invalid' : '' }}" type="text" name="subject_6" id="subject_6" value="{{ old('subject_6', $educationalDetail->subject_6) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mark_6') ? 'is-invalid' : '' }}" type="text" name="mark_6" id="mark_6" value="{{ old('mark_6', $educationalDetail->mark_6) }}">
