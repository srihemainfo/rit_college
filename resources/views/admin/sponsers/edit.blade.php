...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sponsers.update", [$sponser->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sponser_type') ? 'is-invalid' : '' }}" type="text" name="sponser_type" id="sponser_type" value="{{ old('sponser_type', $sponser->sponser_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sponser_name') ? 'is-invalid' : '' }}" type="text" name="sponser_name" id="sponser_name" value="{{ old('sponser_name', $sponser->sponser_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sponsered_items') ? 'is-invalid' : '' }}" type="text" name="sponsered_items" id="sponsered_items" value="{{ old('sponsered_items', $sponser->sponsered_items) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sponsered_to') ? 'is-invalid' : '' }}" type="text" name="sponsered_to" id="sponsered_to" value="{{ old('sponsered_to', $sponser->sponsered_to) }}">
