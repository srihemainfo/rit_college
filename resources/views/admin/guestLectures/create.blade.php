    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.guest-lectures.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('from_date_and_time') ? 'is-invalid' : '' }}" type="text" name="from_date_and_time" id="from_date_and_time" value="{{ old('from_date_and_time') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('to_date_and_time') ? 'is-invalid' : '' }}" type="text" name="to_date_and_time" id="to_date_and_time" value="{{ old('to_date_and_time') }}">
