...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.take-attentance-students.update", [$takeAttentanceStudent->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period') ? 'is-invalid' : '' }}" type="text" name="period" id="period" value="{{ old('period', $takeAttentanceStudent->period) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('taken_from') ? 'is-invalid' : '' }}" type="text" name="taken_from" id="taken_from" value="{{ old('taken_from', $takeAttentanceStudent->taken_from) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('approved_by') ? 'is-invalid' : '' }}" type="text" name="approved_by" id="approved_by" value="{{ old('approved_by', $takeAttentanceStudent->approved_by) }}" required>
